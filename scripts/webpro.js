            ...
            setPointerCapture: function(a, b) {
                if (b.pointerId && !c.hasPointerCapture)
                    if (a.setPointerCapture)
                        ...
                        c.hasPointerCapture = !0;
                    else if (a.msSetPointerCapture)
                        a.msSetPointerCapture(b.pointerId),
                        c.hasPointerCapture = !0
            },
            releasePointerCapture: function(a, b) {
                b.pointerId && c.hasPointerCapture && (a.releasePointerCapture ? a.releasePointerCapture(b.pointerId) : a.msReleasePointerCapture && a.msReleasePointerCapture(b.pointerId),
                delete c.hasPointerCapture)
            },
            scopedFind: function(a, f, c, d) {
                for (var c = " " + c + " ", l = [], a = b(a).find(f), f = a.length, d = b(d)[0], j = 0; j < f; j++)
                    for (var m = a[j], n = m; n; ) {
                ...
                a.find(f).toArray().forEach(function(f) {
                    ...
                    b.each(f, function(f, d) {
                        ...
                        if (n.is(a))
                            return c.push(g),
                            !1;
                        else if (Muse.Utils.isTopLevelWidget(n))
                            return !1;
                        return !0
                    })
                });
    ...
    (function(b, c) {
        ...
        b.extend(c.ImageLoader.prototype, {
            ...
            reprioritize: function(a, b) {
                if (!(this._currentEntry && this._currentEntry.src == a)) {
                    ...
                    for (g = 0; g < this._queue.length; ++g)
                        if (this._queue[g].src == a)
                            break;
                    if (g != 0 && g < this._queue.length)
                        this._queue = this._queue.splice(g, b ? this._queue.length - g : 1).concat(this._queue)
                }
            },
            start: function() {
                if (!this._isRunning)
            ...
            _loadNext: function() {
                ...
                if (a.length) {
                    if (this._needsSort)
                        d = this._queue = a.sort(function(a, b) {
            ...
            _attachBehavior: function() {
                ...
                this.$element.on("keydown", function(b) {
                    if (!a.options.disabled) {
                        ...
                        case 32:
                        case 13:
                            f === 32 && b.preventDefault(),
                            a.options.clickCallback && a.options.clickCallback.call(this, b)
                        }
                    }
                    ...
                    !a.options.disabled && !a.pointerHandled && !a.completelyHandled ? (a.$element.addClass(a.options.activeClass),
                    b(a.$element).on("mouseup", f)) : a.completelyHandled = !1
                }).on("pointerdown", function() {
                    if (!a.options.disabled)
                        a.pointerHandled = !0,
                        a.completelyHandled = !1,
                        a.$element.addClass(a.options.activeClass),
                        b(a.$element).on("pointerup", f)
                });
    ...
    (function(b, c) {
        c.widget("Widget.RadioGroup", c.Widget, {
            ...
            checkButton: function(a) {
                ...
                a !== f ? (f && this.uncheckButton(f),
                a && b(a).addClass(c)) : this.options.toggleStateEnabled && a && (this.uncheckButton(a, c),
                a = null);
                    ...
                    if (f)
                        if (f !== c) {
                            ...
                            for (c = 0; c < f.length; c++)
                                g = f[c],
                                g !== this.tabDriver && g.selectTab(this.activeIndex);
                            this.trigger("wp-panel-show", a)
                        } else
                            this.options.toggleStateEnabled && this.hidePanel(f);
                    --this.showLock
                }
            },
            ...
            addTabGroup: function(a) {
                if (a)
                    for (var a = c.ensureArray(a), f = a.length, h = 0; h < f; h++) {
                        var g = a[h];
                        b.inArray(this.tabGroups, g) === -1 && (this.tabGroups.push(g),
                        g.selectTab(this.activeIndex),
                        g.unbind("wp-tab-select").bind("wp-tab-select", this._tabCallback),
                        this.configureAria(g))
                    }
            },
        ...
        c.Widget.Disclosure.AccordionTransitionPlugin = {
            ...
            _bpDeactivate: function(a) {
                ...
                a.panels.$element.each(function() {
                    ...
                    if (g === "vertical" || g === "both")
                        a.height = "0";
                    if (g === "horizontal" || g === "both")
                        a.width = "0";
            ...
            _attachBehavior: function(a) {
                ...
                if (l && l.length > 0)
                    a.options.marginBottom = Muse.Utils.getCSSIntValue(l, "margin-bottom"),
                    a.options.originalHeight = l[0].scrollHeight;
                a.options.rotatedAccordion = l;
                c.bind("wp-panel-show", function(b, c) {
                    f._showPanel(a, c)
                });
                ...
                g.each(function(a) {
                    var a = a === d
                      , f = {};
                    f.overflow = a ? "" : "hidden";
                    if (k === "vertical" || k === "both")
                        f.height = a ? "auto" : "0";
                    if (k === "horizontal" || k === "both")
                        f.width = a ? "auto" : "0";
                    b(this).css(f)
                })
            },
            ...
            _transitionPanel: function(a, f, c) {
                b("body").trigger("wp-page-height-change", f - a);
                if ((a = c.options.rotatedAccordion) && a.length > 0) {
                    if (c.options.originalHeight == 0 && "undefined" !== typeof f)
                        c.options.marginBottom = Muse.Utils.getCSSIntValue(a, "margin-bottom"),
                        c.options.originalHeight = a[0].scrollHeight;
            ...
            _showPanel: function(a, f) {
                if (!a.$bp || a.$bp.hasClass("active")) {
                    ...
                    if (g === "vertical" || g === "both")
                        k.height = d[0].scrollHeight + "px";
                    if (g === "horizontal" || g === "both")
                        k.width = d[0].scrollWidth + "px";
    ...
    (function(b, c) {
        c.widget("Widget.SlideShowBase", c.Widget, {
            ...
            _executeCall: function(a, b) {
                ...
                if ((!this._$sslbpOverlay || !(this._$sslbpOverlay.hasClass("LightboxContent") && this._$sslbpOverlay.css("opacity") == 0)) && !e.isDefaultPrevented())
                    this["_" + a].apply(this, b) && this.stop(),
    ...
    (function(b, c) {
        c.widget("Widget.ContentSlideShow", c.Widget.SlideShowBase, {
            ...
            _reprioritizeImageLoadingIfRequired: function(a) {
                !this._isLoaded(a) && this._cssilLoader && !this._cssilLoader.isQueueEmpty() && (a = b(this.slides.$element[a]),
                this._cssilLoader.reprioritize(this._getAjaxSrcForImage(a.is("img") ? a : a.find("img")), this.isPlaying()))
            },
            _bpActivate: function() {
            ...
            _attachBehavior: function() {
                ...
                this.tabs = null,
                g.length))
                    this.tabs = new c.Widget.TabGroup(g,{
            ...
            _isLoaded: function(a) {
                if (this._csspIsImageSlideShow && (a = b(this.slides.$element[a]),
                a = a.is("img") ? a : a.find("img"),
                a.length > 0 && (a.hasClass(this.options.imageIncludeClassName) || !a[0].complete)))
                    return !1;
                return !0
            }
        })
    ...
    (function(b, c, a, f, h) {
        c.Widget.ContentSlideShow.fadingTransitionPlugin = {
            ...
            attachBehavior: function(g) {
                ...
                k.bind("wp-panel-show", function(a, f) {
                    ...
                    Muse.Utils.isStackedOrScatteredLayout(g.options.contentLayout_runtime) && i._hideElement(g, g.$closeBtn)
                });
                ...
                if (g.options.elastic === "fullWidth") {
                    ...
                    if (g.options.contentLayout_runtime === "lightbox")
                        g._fstpPositionSlides = p;
                    else
                        q.on("orientationchange resize", function() {
                            p()
                        })
                }
                ...
                if (Muse.Browser.Features.Touch && g.options.enableSwipe === !0) {
                    ...
                    l.each(function() {
                        ...
                        if (f = a.swipe.defaults.excludedElements) {
                            ...
                            if (0 <= n)
                                f.splice(n, 1),
                                a.swipe.defaults.excludedElements = f.join(", ")
                        }
                        a.swipe({
                            triggerOnTouchEnd: !0,
                            ...
                            swipeStatus: function(b, f, n, m) {
                                if (f == "start")
                                    g.stop();
                                else if (f == "move" && (h && (n == "left" || n == "right") || !h && (n == "up" || n == "down")))
                                    !c.hasPointerCapture() && Math.abs(m) > 1 && c.setPointerCapture(a[0], b),
                                    i._scrollTo(g, -1, m * (!j && (n == "left" || n == "up") || j && (n == "right" || n == "down") ? 1 : -1), 0);
                                else if (f == "cancel")
                                    i._scrollTo(g, g.slides.activeIndex, 0, s),
                                    c.releasePointerCapture(a[0], b),
                                    g.trigger("wp-swiped");
                                else if (f == "end") {
                                    f = g.slides.activeIndex;
                                    m = -1;
                                    if (h && (n == "right" && !j || n == "left" && j) || !h && (n == "down" && !j || n == "up" && j))
                                        m = f - 1 < 0 ? l.length - 1 : f - 1;
                                    else if (h && (n == "left" && !j || n == "right" && j) || !h && (n == "up" && !j || n == "down" && j))
                                        m = f + 1 > l.length - 1 ? 0 : f + 1;
                    ...
                    if (!n && c == 0 || m == f) {
                        ...
                        var p = 0
                          ...
                          , s = function() {
                            if (!r && (r = !0,
                            o.show().css("opacity", ""),
                            f != m && a.slides.showPanel(f),
                            ++p == h.length))
                                a._ftpSwipeNoInterrupt = !1
                        };
                        if (o.css("opacity") != o.data("opacity")) {
                            ...
                            s();
                        h.each(function(c) {
                            var n = b(this), m = !1, k = function() {
                                if (!m && (m = !0,
                                n.hide().css("opacity", ""),
                                ++p == h.length))
                                    a._ftpSwipeNoInterrupt = !1
                            }, q;
                            c != f && (n.css("display") != "none" && n.css("opacity") != 0 ? (q = setTimeout(k, d + 10),
                            n.stop(!1, !0).animate({
                                opacity: 0
                            }, d, function() {
                                clearTimeout(q);
                        ...
                        n = q.width(),
                        c > n && (c = n),
                        c = o.data("opacity") * (c / n),
                        n = q.data("opacity") * (1 - c),
                        q.stop(!1, !0).animate({
                            opacity: n
                        }, d),
                        o.stop(!1, !0).show().animate({
                            opacity: c
                        }, d)
                }
            }
        ...
        c.Widget.ContentSlideShow.filmstripTransitionPlugin = {
            ...
            attachBehavior: function(g) {
                ...
                x !== "absolute" && x !== "fixed" && j.elastic !== "fullScreen" && p.css("position", "relative");
                ...
                q.bind("wp-panel-show", function(a, b) {
                    ...
                    g.options.contentLayout_runtime === "stack" && (g.$closeBtn.css("opacity", ""),
                    g.$closeBtn.stop(!0).fadeIn(j.transitionDuration))
                });
                g.options.contentLayout_runtime === "stack" && g.bind("wp-slideshow-close", function() {
                    p.css({
                        opacity: 0.99
                    }).stop(!0).animate({
                        opacity: 0
                ...
                var z = function(a, f) {
                    ...
                    r.parents().each(function() {
                        c = b(this);
                        c.css("display") == "none" && (c.attr("data-margin-left", c.css("margin-left")),
                        c.css("margin-left", "-10000px"),
                        c.css("display", "block"),
                        c.attr("data-display-attr-change", "true"))
                    });
                    if (a === h || f === h)
                        a = m(),
                        f = p.height();
                    ...
                    p.width(a),
                    j.contentLayout_runtime !== "lightbox" && p.css("left", p.position().left - p.offset().left),
                    r.width(a));
                    for (var d = 0, l = n ? a : f, k = g._fstpStyleProp, u = g._fstpStylePropZero, v = 0; v < o.length; v++) {
                        var x = o[v].style;
                        x[u] = "0";
                        x[k] = d + "px";
                        x.margin = "0";
                    ...
                    j.elastic === "off" && (t[n ? "width" : "height"] = n && j.isResponsive ? "100%" : d + "px",
                    t[n ? "height" : "width"] = n ? w + "px" : j.isResponsive ? "100%" : s + "px");
                    r.parents().each(function() {
                        c = b(this);
                        c.attr("data-display-attr-change") == "true" && (c.css("display", ""),
                        c.css("display") != "none" && c.css("display", "none"),
                        c.css("margin-left", ""),
                        c.css("margin-left") != c.attr("data-margin-left") && c.css("margin-left", c.attr("data-margin-left")),
                        c.removeAttr("data-display-attr-change"),
                        c.removeAttr("data-margin-left"))
                    });
                    return d
                };
                z();
                ...
                if (g.$element.attr("data-inside-lightbox") === "true" || Muse.Utils.widgetInsideLightbox(g.$element.parents(".PamphletWidget")))
                    g.$element.attr("data-inside-lightbox", "true"),
                    k.on("lightboxresize", function() {
                        z()
                    });
                q.activeElement || (t[g._fstpStyleProp] = (n ? s : w) + "px",
                t[g._fstpStylePropZero] = "0",
                g.options.contentLayout_runtime === "stack" && g.$closeBtn.hide());
                t.overflow = "visible";
                r.css(t);
                i._goToSlide(g, q.activeElement, j.transitionDuration);
                Muse.Browser.Features.Touch && g.options.enableSwipe === !0 && (b(this),
                n ? r.addClass("horizontalSlideShow") : r.addClass("verticalSlideShow"),
                r.swipe({
                    triggerOnTouchEnd: !0,
                    allowPageScroll: n ? "vertical" : "horizontal",
                    threshold: 75,
                    swipeStatus: function(a, b, f, h) {
                        ...
                        case "start":
                            ...
                            break;
                        case "move":
                            if (n && f in y || !n && f in u)
                                !c.hasPointerCapture() && Math.abs(h) > 1 && c.setPointerCapture(r[0], a),
                                i._scrollBy(g, h * l);
                            break;
                        case "cancel":
                            i._goToSlide(g, q.activeElement, 0);
                            ...
                            break;
                        case "end":
                            i._finalizeSwipe(g, g._fstpOffsetSize * g.slides.activeIndex + h * l, l, f),
                            c.releasePointerCapture(r[0], a)
                        }
                    }
                }))
            ...
            _goToSlide: function(a, f, c) {
                if (a) {
                    ...
                    if (r && s !== -1) {
                        ...
                        if (w !== s) {
                            var u = 0;
                            r === "previous" && s === 0 && w === y ? u = -f[q] : r === "next" && s === y && w === 0 && (a = a.slides.$element[s],
                            u = a[n] + a[q]);
                            u && (p[m] = -u + "px",
                            d.css(m, u + "px"))
                        }
        ...
        c.Widget.ContentSlideShow.slideImageIncludePlugin = {
            ...
            _attachBehavior: function(a) {
                var f = this, c = a._cssilLoader, d, h = a._findWidgetElements("." + a.options.slideClassName);
                ...
                for (var m = h.length, n = "." + a.options.imageIncludeClassName, q = a.options.slideLoadingClassName, o = function(b, c, d, h) {
                    ...
                    var r = h.eq(a._shuffleArray ? a._shuffleArray[p] : p), s = r.is("img") ? r : r.find(n), w = s[0], y, u, t;
                    d.length && (y = b(d[p]),
                    u = y.is("img") ? y : y.find(n),
                    t = u[0]);
            ...
            _handleImageLoad: function(a, f, c, d, j) {
                var m = j.$ele
                  , n = m[0];
                n.src = f;
                if (a.options.elastic !== "off" && b(n).closest(".SSSlideLink").length != 1)
                    m.data("imageWidth", c),
                    m.data("imageHeight", d),
                    a._csspPositionImage(n, a.options.heroFitting, a.options.elastic, c, d);
                else if (b(n).attr("data-heightwidthratio") == h)
                    n.width = j.width || c,
                    n.height = j.height || d;
                n.style.visibility = "";
        ...
        c.Widget.ContentSlideShow.shufflePlayPlugin = {
            ...
            initialize: function(a, f) {
                ...
                a.bind("before-attach-behavior", function() {
                    c._reshuffle(a);
                    if (f.randomDefaultIndex && typeof f.defaultIndex === "undefined")
                        a.options.defaultIndex = a._shuffleArray[0]
                })
            },
            ...
            _handleNext: function(a) {
                if (a.isPlaying()) {
                    ...
                    a._isLoaded(b) && a._isLoaded(f) && (a._goTo(f),
        ...
        d.widget("Widget.Form", d.Widget, {
            ...
            validationTypes: {
                ...
                recaptcha2: function(a) {
                    ...
                    } else if ("undefined" != typeof grecaptcha && "undefined" != typeof muReCAPTCHA2Instances)
                        return a = muReCAPTCHA2Instances[a.attr("id")],
                        (a = grecaptcha.getResponse(a)) && 0 < a.length;
                    return !1
                },
                checkbox: function() {
                    return !0
            ...
            _isEmpty: function(a) {
                ...
                case "checkboxgroup":
                case "radiogroup":
                    return c = c.attr("name"),
                    b('input[name="' + c + '"]:checked').length == 0;
                case "checkbox":
                case "radio":
            ...
            _attachBehavior: function() {
                ...
                this.$element.find("input, textarea").bind("focus blur keydown change propertychange", function(c) {
                    ...
                    case "focus":
                        ...
                        break;
                    case "keydown":
                        "checkbox" != j.data("type") && "radio" != j.data("type") && j.addClass(d).removeClass(l);
                        break;
                    case "blur":
                        j.removeClass(i);
                    ...
                    case "change":
                    case "propertychange":
                        "radio" == j.data("type") && m.find("." + a.options.fieldWrapperClass).removeClass(k),
                        a._isEmpty(j) ? j.addClass(l).removeClass(k) : j.addClass(k).removeClass(l),
                        m && (a._isEmpty(m) ? m.addClass(l).removeClass(k) : m.addClass(k).removeClass(l))
                    }
                });
                switch (this.event) {
                case "blur":
                    ...
                    this.$element.submit(function(c) {
                        ...
                        a.$element.find("." + a.options.fieldWrapperClass).each(function(k) {
                            if ((d = a._validate(b(this)) ? d : !1) && k == i)
                                if (a.options.ajaxSubmit)
                                    c.preventDefault(),
                                    a._submitForm();
                                else {
                                    var k = b("#ReCaptchaAnswer", a.$element)
                                      , l = b("#ReCaptchaChallenge", a.$element);
                                    a.hasReCAPTCHA && 1 == k.length && 1 == l.length && (k.val(Recaptcha.get_response()),
                                    l.val(Recaptcha.get_challenge()))
                                }
                            d || c.preventDefault()
                        });
                        b("." + a.options.fieldWrapperClass, a.$element).each(function() {
                            ...
                            a.val() == "no.reply@example.com" && a.val(""))
                        })
                    })
                }
            },
            ...
            _submitForm: function() {
                ...
                a.hasReCAPTCHA && 1 == c.length && 1 == d.length ? (c.val(Recaptcha.get_response()),
                d.val(Recaptcha.get_challenge()),
                a._validateReCaptcha(function() {
            ...
            _submitFormInternal: function() {
                ...
                b.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        f.$element.find("." + f.options.fieldWrapperClass).removeClass(f.options.focusClass);
                    ...
                    complete: function(j) {
                        ...
                        if (m && m.success) {
                            ...
                            for (m = 0; m < j.length; m++)
                                f._switchState("invalid", j[m]);
                        else
                            f.$element.addClass(i);
            ...
            _getFieldsWithError: function(a) {
                if (!a || !a.error || !a.error.fields || !a.error.fields.length)
                    return null;
            ...
            _switchState: function(a, c) {
                ...
                if (a == "required" || a == "invalid")
                    return a == "invalid" ? c.addClass(k) : c.addClass(l),
                    "recaptcha" != d && this.errorSensitivity != "low" && (i = this.errorSensitivity == "high" ? "keyup" : "blur",
                    c.data("error-state") || (c.data("error-state", !0),
                    c.find("input, textarea").bind(i, m))),
                    !1;
