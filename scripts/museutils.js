...
(function(c) {
        ...
        for (var d = 0; d < a.childNodes.length; d++) {
            ...
            if (i.nodeType == 1) {
                if (!b || b.matches(i))
                    return i;
                if (!c || !c.matches(i))
                    if (i = Muse.Utils.firstDescendant(i, b, c))
                        return i
            }
        }
        return null
    ...
    Muse.Utils.descendants = function(a, b, c, d) {
        ...
        for (var i = 0; i < a.childNodes.length; i++) {
            ...
            l.nodeType == 1 && ((!b || b.matches(l)) && d.push(l),
    ...
    Muse.Utils.allStyleSheetRulesFromOneSheet = function(a, b) {
        ...
        for (var k = [], j = c(window), m = function(a) {
            ...
            var p = g[n];
            if (m(p)) {
                if (p = Muse.Utils.allStyleSheetRulesFromOneSheet(p, b),
                null != p)
                    for (var o = 0; o < p.length; o++)
                        k.push(p[o])
            } else if (Muse.Utils.isDefined(p.selectorText))
                if (d)
                    b(p.selectorText) && k.push(p);
                else
                    for (var o = p.selectorText.split(/\s*,\s*/), q = 0; q < o.length; q++)
                        b(o[q]) && k.push(p)
        }
        ...
        var a = !1
          ...
          , o = function() {
            ...
            for (g = Math.min(g + 2, b.length); h < g; h++)
                if (q = b[h],
                o = q.$elem.offset().left + (m && !m.isStandard() ? m.scrollLeft() : 0),
                t = q.$elem.offset().top + (m && !m.isStandard() ? m.scrollTop() : 0),
                q.from != (a ? o : t)) {
                    k(p);
                    break
                }
            ...
            for (g = b.length; h < g; h++) {
                ...
                for (var x = 0; x < q.length; x++)
                    t = i(q[x]),
                    o && !q[x].hasClass(t) ? q[x].addClass(t) : !o && q[x].hasClass(t) && q[x].removeClass(t)
            }
        }
          , q = function() {
            j || (j = !0,
            Muse.Utils.requestAnimationFrame(o))
        };
    ...
    Muse.Utils.saveHyperlinkInfo = function(a, b, d, g, i) {
        ...
        if (l && -1 != l.indexOf("#") && !(m && m != "_self") && !(0 <= k.indexOf("/")) && (n.charAt(n.length - 1) == "/" && (n += "index.html"),
    ...
    Muse.Utils.adjustTargetAndSlideHeights = function(a, b) {
        ...
        b === "lightbox" ? a.css("height", i + "px") : a.css("height", a.outerHeight() + "px")
    }
    ;
    ...
    Muse.Utils.applyPinningToLightboxParts = function(a, b) {
        for (var d = 0; d < b.children().length; d++) {
            ...
            if (l != void 0) {
                ...
                k && Muse.Utils.isLeftInPercentForLightbox(i.parent()) && (l = m * 100 / i.parent().width(),
                i.css("margin-left", l + "%"),
                i.css("left", "0px"),
                g.css("left", j + "px"),
    ...
    Muse.Utils.detachIframesAndObjectsToPauseMedia = function(a) {
        ...
        c("iframe, object", a).each(function() {
            ...
            if (!a.is("object") || !(b.browser.msie && b.browser.version < 9)) {
                ...
                i.$next = a.next();
                i.$parent = a.parent();
                b.browser.msie ? (i.html = a.wrap('<div id="deleteMeWrapper"/>').parent().html(),
                a.remove(),
                i.$parent.children("div #deleteMeWrapper").remove()) : (i.$node = a.clone(),
                a.remove());
                f.push(i)
            }
        });
    ...
    Muse.Utils.getLeft = function(a, b) {
        ...
        if (i !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort)
            if (d.$element.css("position") === "static" || d.left === "auto")
                ...
                d.left = i;
        if ((d.$element.css("position") === "static" || d.left === "0px" || d.left === "0%" || d.left === "auto") && i !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort)
            d.left = i;
        return d
    }
    ;
        ...
        c.each(d, function(a, d) {
            ...
            if (h[0] !== void 0 && b.closest(h).length) {
                ...
                if (Muse.Utils.isInPixel(j))
                    ...
                    Muse.Utils.isInPixel(j) && j !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort && (g += parseFloat(j)),
            ...
            case "page_fixedLeft":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, c, !0)
                      ...
                      , n = 0
                      , p = 0;
                    Muse.Utils.isInPercentage(b) ? (j = parseFloat(b) / 100,
                    b = Muse.Utils.getWidths(a),
                    p = b.elemWidth,
                    f = b.offsetWidth) : Muse.Utils.isInPixel(b) && (j = a.offsetParent().width(),
                    p = parseFloat(b),
                    j = j > 0 ? p / j : 0);
                    j > 0 && (f > Math.round(p) && (n = f - Math.round(p)),
                    b = Math.abs(Muse.Utils.isValueWithinTolerance(j, 1, 1.0E-4) ? a.outerWidth() : (m + n) / (1 - j)),
            ...
            case "page_fixedCenter":
                a.forEach(function(a) {
                    var b = window.getComputedStyle(a[0]).left
                      ...
                      , q = 0;
                    if (b !== 0)
                        Muse.Utils.isInPercentage(j) ? m = parseFloat(j) / 100 : Muse.Utils.isInPixel(j) && (m = a.parent().width(),
                        j = parseFloat(j),
                        m = m > 0 ? j / m : 0),
                        Muse.Utils.isInPercentage(n) ? (n = Muse.Utils.getWidths(a),
                        q = n.elemWidth,
                        p = n.offsetWidth) : Muse.Utils.isInPixel(n) && (q = parseFloat(n)),
                        m > 0 && (b > 0 && p > Math.round(q) && (o = p - Math.round(q)),
                        Muse.Utils.setMinWidthInformation(d, a, Math.abs((f + o) / m)))
                })
            }
        return d
    }
            ...
            case "page_fixedCenter":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, d, !1)
                      ...
                      , o = 0
                      , q = -1;
                    Muse.Utils.isInPercentage(f) ? o = parseFloat(f) / 100 : Muse.Utils.isInPixel(f) && (o = a.parent().width(),
                    f = parseFloat(f),
                    o = o > 0 ? f / o : 0);
                    o > 0 && (q = Muse.Utils.getLeftAdjustmentAmountDoneByParents(a, g),
                    q = q < 0 ? 0 : q,
                    f = (Math.abs(c) - q) / o,
                    c < 0 ? c += q : c > 0 && (c -= q),
                    Muse.Utils.isValueWithinTolerance(o, 1, 1.0E-4) || (i = (b + c) / (1 - o)),
                    q = Math.max(f, i, b),
    ...
    Muse.Utils.computeMinWidthForChildsWithMinWidth = function(a, b) {
        ...
        a.forEach(function(a) {
            ...
            d !== void 0 && (l = Muse.Utils.computeMinWidthForFixedChilds([a], d, !0, b),
    ...
    Muse.Utils.getMinWidthOfParts = function(a, b, d) {
        ...
        if (a && b && !c.isEmptyObject(a) && !c.isEmptyObject(b) && b[0] && a[0]) {
            ...
            if (k === "fixed")
                ...
                case "page_fluidx":
                    k = -1;
                    o.left <= r.left ? (o = r.left - o.left,
                    o >= 0 && (k = o / p)) : r.left - o.left < 2 && (k = 0);
                    k >= 0 && (Muse.Utils.isValueWithinTolerance(k, 1, 1.0E-4) ? l = 0 : k < 1 && (l = q / (1 - k)));
                    break;
                case "page_fixedLeft":
                    n || (p = -1,
                    o.left <= r.left ? p = r.left - o.left : r.left - o.left < 2 && (p = 0),
                    p >= 0 && (l = q + p));
                    break;
                case "page_fixedRight":
                    n || (p = -1,
                    o.right >= r.right ? p = o.right - r.right : o.right - r.right < 2 && (p = 0),
                    p >= 0 && (l = q + p));
                    break;
                case "page_fixedCenter":
                    n || (p <= q ? l = q : r.left <= o.left || r.right >= o.right ? (p = o.left - r.left,
                    k = r.right - o.right,
                    p >= 0 && k <= 0 ? l = q + (o.right - r.right) : k >= 0 && p <= 0 && (l = q + (r.left - o.left))) : (r = r.left + q / 2,
                    o = o.left + p / 2,
                    p = -1,
                    p = r === o ? 0 : r < o ? o - r : r - o,
                    p >= 0 && (l = 2 * (q / 2 + p))))
    ...
    Muse.Utils.getMinWidthForElement = function(a, b) {
        ...
        if (a && a.length > 0 && a[0].style.minWidth === "" || b) {
            ...
            i.push(Muse.Utils.computeMinWidthForChildsWithMinWidth(d.ChildWithMinWidth, a));
    ...
    Muse.Utils.buttonsMinWidthHelper = function() {
        ...
        c(".Button").each(function() {
            ...
            a.removeAttr("data-visibility")) : a.children() && a.children().attr("data-visibility") === "changed" && (a.children().css("visibility", ""),
    ...
    Muse.Utils.VimeoVideoHelper = function(a) {
        ...
        window.addEventListener ? window.addEventListener("message", l, !1) : window.attachEvent("onmessage", l, !1);
        l = function() {}
        ;
    ...
    (function(a) {
        ...
        d.prototype.init = function(d) {
            ...
            if (0 != this.$verticalSpacer.length) {
                ...
                b.resize(function() {
                    if (k) {
                        var a = b.width();
                        l ? (i.splice(0, i.length),
                        i.push(a),
                        l = !1,
                        setTimeout(function() {
                            l = !0
                        }, 200)) : i[i.length - 1] != a && (i.push(a),
                        3 < i.length && i[i.length - 3] == i[i.length - 1] && (c.addClass("always_vert_scroll"),
                        k = !1))
                    }
                    j.doUpdate()
                });
        ...
        0 < k && 0 < j && 300 == j - k ? (l.remove(),
        l = new d) : (a("html").removeClass("css_verticalspacer"),
        l = new i);
    ...
    Muse.Utils.animationFrameFx = function(a) {
        var b = a.fx;
        a.extend(b, a.fx);
        var c, d = a(window).data("stickyFooter"), i = function() {
            c && (Muse.Utils.requestAnimationFrame(i),
            b.tick(),
            d.doUpdate())
        };
        b.timer = function(b) {
